...
export type CalendarDataWithMetadata = CalendarData & { metadata: CalendarMetadata };
...
export type OnDatePress = undefined | ((date: Date, options: DateOptions) => void);

export type RenderDate = (props: { date: Date } & DateOptions) => JSX.Element | null;

export type RenderHeader = (props: { startDate: Date; endDate: Date }) => JSX.Element | null;

export type RenderDayLabel = (props: { date: Date }) => JSX.Element | null;

export type RenderMoreItemText = (props: { count: number }) => JSX.Element | null;
...
export type DateString = `${number}${number}${number}${number}-${'01' | '02' | '03' | '04' | '05' | '06' | '07' | '08' | '09' | '10' | '11' | '12'}-${
    | '01'
    | '02'
    | '03'
    | '04'
