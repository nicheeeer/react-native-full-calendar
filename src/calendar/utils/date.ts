import { addDays, differenceInCalendarDays, differenceInWeeks, endOfMonth, endOfWeek, format, isAfter, isSameDay, isWithinInterval, startOfMonth, startOfWeek } from 'date-fns';
...
export const getIterableDateBetweenDates = (startDate: Date, endDate: Date): DateString[] => {
    const dates = [];
